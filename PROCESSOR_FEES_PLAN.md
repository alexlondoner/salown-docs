...
> **Status (2026-09-07):** 🟡 **B0 design complete; B1 not implemented.** Phase 0 (the online tender leg) is LIVE
> (`FIN-ONLINE-TENDER`, R-2026-09-05-B). Nothing below Phase 0 exists in code. This document is the B0 data
> contract; it is not an implementation or release approval.
...
**B1 blockers: none.** B1 is gated only by an explicit implementation approval and, at release time, the targeted-deploy
approval.
