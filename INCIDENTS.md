...
**Severity:** 🟠 High (müşteri 3 kez ödeyemedi; kendi kendine çözüldü) · **Owner:** Claude (rc3 session) + owner · **Status:** 🟡 Open — **KÖK NEDEN KESİNLEŞTİ (loglarla):** site `http://` (şifresiz) açılınca ödeme CORS'u kırık; kalıcı fix = GH Pages Enforce HTTPS (owner toggle)
