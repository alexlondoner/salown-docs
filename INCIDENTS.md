...
**Severity:** 🟡 Medium (wrong day displayed; no data or money touched) · **Owner:** Claude + owner · **Status:** ✅ Resolved (`e22dcc2`, salown-app) · **Affected area:** Finance — Day/Month date selection
...
**Regression Tests:** none (the logic lives inside a component `useEffect`; extracting a clamp helper is the prerequisite — not done, deliberately out of scope)
**Related:** commits `e22dcc2` · files `salown-app/src/pages/Finance.tsx` · related `c66320d` / `4b7b592` (the leave guards that were wrongly suspected)
