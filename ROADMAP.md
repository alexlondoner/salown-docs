...
- 🔵 **Slice 3b KALAN (owner ile):** (1) **Revenue SSOT** — OverviewPanel gross `bookingRev` vs Reports net/paidAmount aynı sayfada görünür oldu, tek kaynağa indir (Finance ile tut). (2) **Tasarım polish** — owner tercihi: iki-kolon "sayılı grafik sol / cash-card sağ"; rakamlar+% artışlar daha büyük/belirgin, boşluk azalt.
