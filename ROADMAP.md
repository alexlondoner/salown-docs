...
**🔵 SIRADAKI — Marketing ↔ Analytics ayrımı** (owner kararı 2026-07-04): Marketing modülü artık zengin (attribution + codes + recovered revenue + engagement); sırada analytics/reporting'i AYRI bölüme ayırmak (şu an Marketing tab'inde karışık: occupancy/weekday/top-clients analytics ⟂ campaigns/attribution/codes marketing). Kalan marketing derinleştirme: scheduling (C3.1), suggestion ranking (C4).
