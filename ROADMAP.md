...
- 🟡 **Filtre-scope netliği** (`7d5fc77` interim): Overview'da İKİ filtre var — OverviewPanel'in 2w/4w/8w'si (kendi window'u) + üst-sağ dönem seçici (Reports finansal kartları + diğer sekmeler). İkisi de ÇALIŞIYOR (test: 2w→sources 492/134; Last 90→header 45/763) ama üst-sağ dönem OverviewPanel'i etkilemiyor → "bozuk" görünüyor. Şimdilik iki kapsam etiketlendi ("Current performance · 2w/4w/8w" vs "PERIOD SNAPSHOT · top-right filter"). **KALAN karar (owner):** (A) Overview'da üst-sağ dönemi gizle + finansal kartları Breakdown'a taşı = her sekmede tek filtre [öneri], (B) OverviewPanel üst-sağ döneme uysun (This Week/MoM sabit kalır), (C) sadece etiket kalsın.
