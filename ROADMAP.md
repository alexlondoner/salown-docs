...
- **Durum:** ✅ inceleme+spec+kapsam (2026-07-11) · 🔵 Faz 1 kod (gate: 2026-07-14'ten önce yazılmaz — 12=rc3, 13=ürün-doğrulama; migration-sonrası ilk uygun dilim adayı) · 🔵 Faz 2 görsel tasarım (owner Claude Design ile yaptıracak, session mockup üretmez) → onay sonrası kod.
...
**G1 — Minor** · 🔵
- **www.whitecrossbarbers.com → apex 301 redirect** (2026-07-13 gece): www artık Firebase'den servis ediliyor (CNAME `whitecrossbarbers-saas.web.app`, cert ✓) ama apex'e redirect DEĞİL, aynı içeriği ikinci host olarak sunuyor → SEO için Console'da www kaydını "redirect to whitecrossbarbers.com" yap (1 dk). Ayrıca kalan kapanış: GH Pages custom domain kaldır + repo private (owner yapacak).
