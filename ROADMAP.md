...
> - [ ] **A3 inventory stockQty** — A3-1 domain foundation ✅ (2026-07-29, `34ddb12`, NOT WIRED / NOT DEPLOYABLE). Remaining A3-2: transactional callable + idempotency marker + checkout/createProductSale cutover + `stockQty` UI + low-stock warning + rules guard. *(Payments theme)*
