...
✅ **Adım 2a CANLI (2026-07-13, `282e5ae`):** resolver artık shiftChange override'ını tanıyor (açık override bayat closed'u yener — dört panel formu otomatik düzeldi) + Barbers kaydı workingDays'teki günlerin closed bayrağını otomatik temizliyor (çelişkili durum yazılamaz). KALAN adım 2b: grid'in leave-farkındalığı + staff-app geçişi (staff app = diğer cihaz koordinasyonu) + adım 3-6.
