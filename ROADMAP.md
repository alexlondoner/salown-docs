...
**H4 — Parser mail girişi: parse-inbox hybrid + token izolasyon** · ✅ **ALTYAPI CANLI + UÇTAN UCA KANITLI (2026-07-13 akşam)** — kalan tek adım: whitecross Gmail'inde token adresine forward (gerçek-mail pilotu)
