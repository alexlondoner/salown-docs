...
**🟡 Marketing ↔ Analytics ayrımı — SLICE 1+2+3a DONE (2026-07-05), slice 3b kaldı:**
...
- 🔵 **Slice 3b (KALAN, owner ile):** Marketing'de `overview` sekmesi hâlâ duruyor — Reports'ta OLMAYAN özel metrikler içeriyor (MoM, iptal oranları, revenue quality, weekly-target editörü, AI insights). Bunları Reports'a **porte et + iki revenue formülünü uzlaştır** (Marketing `bookingRev` gross vs Reports `bookingNetWithoutTip`/paidAmount — SSOT seç), sonra Marketing'den kaldır → Marketing = sadece campaigns. Owner canlı rakamları doğrulamalı (blind yapılmıyor — revenue formül riski).
