...
| **Production business-data writes** | **ZERO.** No booking, callable or Firestore document touched. **Still pending:** the controlled BookingForm / `salownEditBookingForm` live test on tr-demo (`m9GXB797lKKb83CNY1a4`, own approval) → then C1 fully LIVE_VERIFIED. C1 status now: patch/panel LIVE_VERIFIED · form LIVE_UNPROVEN (adapter fix live) · C1 PARTIALLY_LIVE_VERIFIED |
