...
| **B1b hardening** (`FIN-B1B-HARDENING`) | **SOURCE_READY_NOT_DEPLOYED** (2026-09-15) — candidate for a B1b-inclusive release | whitecross-site `ecd029ab` (claim `03d21f36`, released `b52dd26a`); 223/223 tests; refund observations, documented-transition ordering with a conflict rule, `REFUND_FEE_ACTUAL` entries, deterministic compensation ids, and the **new-scope** Stripe Events backstop (plan §6.3.1, §3.1) |
