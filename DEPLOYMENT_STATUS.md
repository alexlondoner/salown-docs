...
> ---
>
> ### 📍 CURRENT — **2026-09-24 `R-2026-09-24-B` + `-C` — Admin A1 loyalty reader, then A2 Reports passive-barber**: `hosting:salown` `ef9aceae78492916` → `a6d11adb4593c912` (A1, `764ff84`) → **`24930db8f0625b04`** (A2, `41b15ce` = A1 + Reports). Rollback A2 → `a6d11adb4593c912`, A1 → `ef9aceae78492916`. Home still NOT released.
>
