...
> ---
>
> ### 📍 CURRENT — **2026-09-25 `R-2026-09-25-D` — Home recorded-name note removed (visual only)**: `hosting:salown` `5c56a953570b90e9` → **`e385dead99e13249`** (`05083a7` = live `45029ad` + note removal). Rollback `5c56a953570b90e9`. Main carries it (`a39632d`, `541fb54`).
>
