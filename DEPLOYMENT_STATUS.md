...
> ---
>
> ### 📍 CURRENT — **`hosting:salown-staff` RELEASED 2026-09-20 (`R-2026-09-20-B`, version `dc3e5984e1b9a63f`); `hosting:salown` re-read the same day after `R-2026-09-20-A` and verified UNCHANGED by that Staff release**; `functions:salown` as of 2026-09-19; every other row is still as of 2026-09-09
>
> | Unit | Live now | Gap |
> |---|---|---|
...
> | `hosting:salown` | **`be573ea0498fc71f`** (released 2026-09-20T13:06:51.896Z, `R-2026-09-20-A`, from **`5be583c`** = live `56ceccc` + the shadow-bundle config fix, isolated-archive build) | ✅ **RECORDED** — `SHADOW-STAFF-BUNDLE`: `salown.com/staff-bundle/**` no longer publishes a pre-enforcement Staff app; it now **302**s to `staff.salown.com`. Version file count **122 → 97 (−25)**, bytes −1,506,826; all 55 Admin bundle files byte-identical to the pinned build; `/`, `/app`, `/book/**` 200. Supersedes `07c90b756c541a6a` (`R-2026-09-19-D`, from `56ceccc`), which is the rollback identity — and which itself superseded ~~`827946e295c69eeb`~~ (`R-2026-09-12-A`), a value this row carried until today. ⚠️ **`main` does not carry the fix**: an Admin deploy from `main` would republish the shadow bundle |
