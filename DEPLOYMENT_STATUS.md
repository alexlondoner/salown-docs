...
> ---
>
> ### 📍 CURRENT — **2026-09-25 `R-2026-09-25-A` — Admin Home released**: `hosting:salown` `24930db8f0625b04` → **`862cebeba11b1063`** (`464ee53` = live `41b15ce` + Home with event-scoped Ignore). Rollback `24930db8f0625b04`. Main carries it (`b59973a`).
>
