...
> ---
>
> ### 📍 CURRENT — **2026-09-25 `R-2026-09-25-E` — GRID-PRODUCT-SALE: product-only sales off the Admin calendar and its appointment counts**: `hosting:salown` `e385dead99e13249` → **`c119f7a6d7780365`** (`d6312c6` = live `05083a7` + 3 files). Rollback `e385dead99e13249`. Main carries it (`6762ebd`, `aa483ca`, `3c47223`).
>
