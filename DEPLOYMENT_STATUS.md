...
> ---
>
> ### 📍 CURRENT — **`hosting:salown` RELEASED 2026-09-22 (`R-2026-09-22-B`, version `8ad0529e5e7be72e`) — FIN-B2a fee display, LIVE_VERIFIED including an authenticated UI pass**; `functions:whitecross` as of 2026-09-22 (`R-2026-09-22-A`, both legs now production-verified); `hosting:salown-staff` as of 2026-09-21; `functions:salown` as of 2026-09-19; every other row is still as of 2026-09-09
>
> | Unit | Live now | Gap |
> |---|---|---|
