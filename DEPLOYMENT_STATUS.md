...
> ---
>
> ### 📍 CURRENT — 2026-09-09, one screen · **`hosting:salown-staff` + `functions:salown` rows re-read live 2026-09-13 after `R-2026-09-13-A`; `hosting:salown` re-read live 2026-09-12 after `R-2026-09-12-A`; every other row is still as of 2026-09-09**
>
> | Unit | Live now | Gap |
> |---|---|---|
...
> | `hosting:salown-staff` | **`62aa1ac4a0302593`** (released 2026-09-13T00:43:27Z, `R-2026-09-13-A`, from `797c9b3`, isolated-workspace build) | ✅ **RECORDED — Phase 1 New Booking callable transition published (STAFF-AVAIL-GAP-P1, NOT full enforcement — see caveat).** Served bundle `staff-BXzTWOQ6.js` sha256 `c596ad37…` byte-identical to the pinned build; source markers `"Owner authorization is required for this."` + `OVERRIDE_REQUIRES_OWNER` confirmed present (proves the `631b768` bug fix shipped, not just the `a7c79f3` gate). Supersedes `48282d9b843c630b` (`R-2026-09-11-C`). ⚠️ `firestore.rules`' `isTenantAny` bypass is UNCHANGED and remains STAFF-AVAIL-GAP's stated closing criterion; Phases 2-4 not started |
